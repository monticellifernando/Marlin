...
#define STRING_CONFIG_H_AUTHOR "Zshman" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MontXYZ"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 50, 0 }
...
// CoreYX -> X inverted: Y ->  Inverted, X -> OK
